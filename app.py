...
# ==========================================
st.set_page_config(page_title="Portal de Precificação", page_icon="🔒", layout="wide")
...
# ==========================================
# O ID_CLIENTE AGORA É DINÂMICO BASEADO NO LOGIN!
...
def inicializar_padroes_caso_vazio():
    ...
    st.session_state["df_custos_categorias"] = {
        ...
        "4. Despesas estrutura e de consumo": pd.DataFrame([{"ÍTEM": "4.1 Aluguel", "MENSAL (R$)": 0.0}])
    }
    salvar_estado_nuvem()
...
with st.sidebar:    
    ...
    if st.button("🚪 Sair (Logout)", use_container_width=True):
        st.session_state.clear() # Limpa TUDO para o próximo login ser limpo
        st.rerun()
